...
$sql_logar = "SELECT * FROM aluno  WHERE matricula = '$matricula' && senha = '$senha'";
...
if ($num_logar == 0){
	sleep();
	echo "<script> alert('Matricula ou senha inválido.');</script>";
   ...
   $_SESSION['senha'] = $senha;
	header("Location: ../usuarios/index.php?us=$matricula");
}
