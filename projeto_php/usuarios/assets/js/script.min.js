if ($(function () {
        $(document).on("click", "#bootlint-check", function () {
            var t = $('script[src="https://maxcdn.bootstrapcdn.com/bootlint/latest/bootlint.min.js"]').length;
            if (t) bootlint.showLintReportForCurrentDocument([]);
            else {
                var e = document.createElement("script");
                e.src = "https://maxcdn.bootstrapcdn.com/bootlint/latest/bootlint.min.js", document.body.appendChild(e), e.onload = function () {
...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        ...
        easeInElastic: function (t, e, i, n, a) {
            ...
            return -(s * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * a - o) * (2 * Math.PI) / r)) + i
        },
        easeOutElastic: function (t, e, i, n, a) {
            ...
            return s * Math.pow(2, -10 * e) * Math.sin((e * a - o) * (2 * Math.PI) / r) + n + i
        },
        easeInOutElastic: function (t, e, i, n, a) {
            ...
            if (r || (r = a * (.3 * 1.5)), s < Math.abs(n)) {
                s = n;
                var o = r / 4
            } else var o = r / (2 * Math.PI) * Math.asin(n / s);
            return 1 > e ? -.5 * (s * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * a - o) * (2 * Math.PI) / r)) + i : s * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * a - o) * (2 * Math.PI) / r) * .5 + n + i
        },
            ...
            i.isWindow = function (t) {
                ...
                for ("boolean" == typeof s && (u = s, s = arguments[l] || {}, l++), "object" != typeof s && "function" !== i.type(s) && (s = {}), l === c && (s = this, l--); c > l; l++)
                    if (null != (o = arguments[l]))
                        for (a in o) t = s[a], n = o[a], s !== n && (u && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1, r = t && i.isArray(t) ? t : []) : r = t && i.isPlainObject(t) ? t : {}, s[a] = i.extend(u, r, n)) : void 0 !== n && (s[a] = n));
                return s
        ...
        return function (t, e, i, n) {
            ...
            function l(t, i, n, a) {
                ...
                function f(e) {
                    for (var i = 0, a = 1, o = b - 1; a != o && k[a] <= e; ++a) i += w;
                    --a;
                    var r = (e - k[a]) / (k[a + 1] - k[a]),
                        s = i + r * w,
                        l = c(s, t, n);
                    return l >= g ? u(e, s) : 0 == l ? s : p(e, i, i + w)
                }
            ...
            function c(t, e) {
                var i = t;
                return v.isString(t) ? b.Easings[t] || (i = !1) : i = v.isArray(t) && 1 === t.length ? s.apply(null, t) : v.isArray(t) && 2 === t.length ? w.apply(null, t.concat([e])) : !(!v.isArray(t) || 4 !== t.length) && l.apply(null, t), i === !1 && (i = b.Easings[b.defaults.easing] ? b.defaults.easing : y), i
            }
                            ...
                            for (var m = Math.min((e - f) / c.duration, 1), y = 0, w = l.length; w > y; y++) {
                                ...
                                if (r(T)) {
                                    ...
                                    for (var O in C)
                                        if ("element" !== O) {
                                            var E, A = C[O],
                                                I = v.isString(A.easing) ? b.Easings[A.easing] : A.easing;
                                            if (1 === m) E = A.endValue;
                                            else {
                                                var q = A.endValue - A.startValue;
                                                if (E = A.startValue + q * I(m, c, q), !h && E === A.currentValue) continue
                                            }
                                            if (A.currentValue = E, "tween" === O) g = E;
                                            else {
                                                if (x.Hooks.registered[O]) {
                                                    var M = x.Hooks.getRoot(O),
                                                        _ = r(T).rootPropertyValueCache[M];
                                                    _ && (A.rootPropertyValue = _)
                                                }
                                                var j = x.setPropertyValue(T, O, A.currentValue + (0 === parseFloat(E) ? "" : A.unitType), A.rootPropertyValue, A.scrollData);
                                                x.Hooks.registered[O] && (r(T).rootPropertyValueCache[M] = x.Normalizations.registered[M] ? x.Normalizations.registered[M]("extract", null, j[1]) : j[1]), "transform" === j[0] && (S = !0)
                                            }
                                        }
                                    c.mobileHA && r(T).transformCache.translate3d === n && (r(T).transformCache.translate3d = "(0px, 0px, 0px)", S = !0), S && x.flushTransformCache(T)
                                }
                            }
                            c.display !== n && "none" !== c.display && (b.State.calls[o][2].display = !1), c.visibility !== n && "hidden" !== c.visibility && (b.State.calls[o][2].visibility = !1), c.progress && c.progress.call(s[1], s[1], m, Math.max(0, f + c.duration - e), f, g), 1 === m && d(o)
                        }
                }
            ...
            function d(t, e) {
                ...
                for (var i = b.State.calls[t][0], a = b.State.calls[t][1], o = b.State.calls[t][2], s = b.State.calls[t][4], l = !1, c = 0, u = i.length; u > c; c++) {
                    var d = i[c].element;
                    if (e || o.loop || ("none" === o.display && x.setPropertyValue(d, "display", o.display), "hidden" === o.visibility && x.setPropertyValue(d, "visibility", o.visibility)), o.loop !== !0 && (p.queue(d)[1] === n || !/\.velocityQueueEntryFlag/i.test(p.queue(d)[1])) && r(d)) {
                        ...
                        p.each(x.Lists.transforms3D, function (t, e) {
                            ...
                            r(d).transformCache[e] !== n && new RegExp("^\\(" + i + "[^.]").test(a) && (f = !0, delete r(d).transformCache[e])
            ...
            var w = function () {
                ...
                return function t(e, n, a) {
                    var o, r, s, l = {
                        ...
                        d = 1e-4,
                        p = .016;
                    for (e = parseFloat(e) || 500, n = parseFloat(n) || 20, a = a || null, l.tension = e, l.friction = n, o = null !== a, o ? (u = t(e, n), r = u / a * p) : r = p; s = i(s || l, r), c.push(1 + s.x), u += 16, Math.abs(s.x) > d && Math.abs(s.v) > d;);
                    return o ? function (t) {
            ...
            var x = b.CSS = {
                ...
                getPropertyValue: function (t, i, a, o) {
                    function s(t, i) {
                        ...
                        if (8 >= f) l = p.css(t, i);
                            ...
                            var h;
                            h = r(t) === n ? e.getComputedStyle(t, null) : r(t).computedStyle ? r(t).computedStyle : r(t).computedStyle = e.getComputedStyle(t, null), "borderColor" === i && (i = "borderTopColor"), l = 9 === f && "filter" === i ? h.getPropertyValue(i) : h[i], ("" === l || null === l) && (l = t.style[i]), a()
                        }
                ...
                flushTransformCache: function (t) {
                    ...
                    var i = "";
                    if ((f || b.State.isAndroid && !b.State.isChrome) && r(t).isSVG) {
                        var n = {
                        ...
                        p.each(r(t).transformCache, function (e) {
                            return a = r(t).transformCache[e], "transformPerspective" === e ? (o = a, !0) : (9 === f && "rotateZ" === e && (e = "rotate"), void(i += e + a + " "))
                        }), o && (i = "perspective" + o + " " + i)
                    }
            ...
            var C = function () {
                    ...
                    function t(t) {
                        function d(t, e) {
                            var i = n,
                                a = n,
                                r = n;
                            return v.isArray(t) ? (i = t[0], !v.isArray(t[1]) && /^[\d-]/.test(t[1]) || v.isFunction(t[1]) || x.RegEx.isHex.test(t[1]) ? r = t[1] : (v.isString(t[1]) && !x.RegEx.isHex.test(t[1]) || v.isArray(t[1])) && (a = e ? t[1] : c(t[1], s.duration), t[2] !== n && (r = t[2]))) : i = t, e || (a = a || s.easing), v.isFunction(i) && (i = i.call(o, T, k)), v.isFunction(r) && (r = r.call(o, T, k)), [i || 0, a, r]
                        }
                        ...
                        if ("scroll" === E) {
                            var w, C, S, P = /^x$/i.test(s.axis) ? "Left" : "Top",
                                A = parseFloat(s.offset) || 0;
                            s.container ? v.isWrapped(s.container) || v.isNode(s.container) ? (s.container = s.container[0] || s.container, w = s.container["scroll" + P], S = w + p(o).position()[P.toLowerCase()] + A) : s.container = null : (w = b.State.scrollAnchor[b.State["scrollProperty" + P]], C = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === P ? "Top" : "Left")]], S = p(o).offset()[P.toLowerCase()] + A), l = {
                                scroll: {
                                    rootPropertyValue: !1,
                                    startValue: w,
                                    currentValue: w,
                            ...
                            var I = p.extend(!0, {}, r(o).tweensContainer);
                            for (var q in I)
                                if ("element" !== q) {
                                    var M = I[q].startValue;
                                    I[q].startValue = I[q].currentValue = I[q].endValue, I[q].endValue = M, v.isEmptyObject(y) || (I[q].easing = s.easing), b.debug && console.log("reverse tweensContainer (" + q + "): " + JSON.stringify(I[q]), o)
                                }
                            l = I
                        } else if ("start" === E) {
                            var I;
                            r(o).tweensContainer && r(o).isAnimating === !0 && (I = r(o).tweensContainer), p.each(g, function (t, e) {
                                if (RegExp("^" + x.Lists.colors.join("$|^") + "$").test(t)) {
                                    ...
                                    if (x.RegEx.isHex.test(a)) {
                                        for (var s = ["Red", "Green", "Blue"], l = x.Values.hexToRgb(a), c = r ? x.Values.hexToRgb(r) : n, u = 0; u < s.length; u++) {
                                            var p = [l[u]];
                                            o && p.push(o), c !== n && p.push(c[u]), g[t + s[u]] = p
                                        }
                                        delete g[t]
                                    }
                                }
                            ...
                            for (var _ in g) {
                                ...
                                var N = x.Hooks.getRoot(_),
                                    Q = !1;
                                if (r(o).isSVG || "tween" === N || x.Names.prefixCheck(N)[1] !== !1 || x.Normalizations.registered[N] !== n) {
                                    (s.display !== n && null !== s.display && "none" !== s.display || s.visibility !== n && "hidden" !== s.visibility) && /opacity|filter/.test(_) && !H && 0 !== z && (H = 0), s._cacheValues && I && I[_] ? (H === n && (H = I[_].endValue + I[_].unitType), Q = r(o).rootPropertyValueCache[N]) : x.Hooks.registered[_] ? H === n ? (Q = x.getPropertyValue(o, N), H = x.getPropertyValue(o, _, Q)) : Q = x.Hooks.templates[N][1] : H === n && (H = x.getPropertyValue(o, _));
                                    var F, $, W, X = !1;
                                    if (F = f(_, H), H = F[0], W = F[1], F = f(_, z), z = F[0].replace(/^([+-\/*])=/, function (t, e) {
                                            return X = e, ""
                                        }), $ = F[1], H = parseFloat(H) || 0, z = parseFloat(z) || 0, "%" === $ && (/^(fontSize|lineHeight)$/.test(_) ? (z /= 100, $ = "em") : /^scale/.test(_) ? (z /= 100, $ = "") : /(Red|Green|Blue)$/i.test(_) && (z = z / 100 * 255, $ = "")), /[\/*]/.test(X)) $ = W;
                                    else if (W !== $ && 0 !== H)
                                        if (0 === z) $ = W;
                                        else {
                                            a = a || m();
                                            var R = /margin|padding|left|right|width|text|word|letter/i.test(_) || /X$/.test(_) || "x" === _ ? "x" : "y";
                                            switch (W) {
                                                case "%":
                                                    H *= "x" === R ? a.percentToPxWidth : a.percentToPxHeight;
                                                    break;
                                                case "px":
                                                    break;
                                                default:
                                            ...
                                            switch ($) {
                                                case "%":
                                                    H *= 1 / ("x" === R ? a.percentToPxWidth : a.percentToPxHeight);
                                                    break;
                                                case "px":
                                                    break;
                                                default:
                                    ...
                                    l[_] = {
                                        ...
                                        unitType: $,
                                        easing: L
                                    }, b.debug && console.log("tweensContainer (" + _ + "): " + JSON.stringify(l[_]), o)
                ...
                if (v.isWrapped(this) ? (s = !1, f = 0, h = this, l = this) : (s = !0, f = 1, h = w ? arguments[0].elements || arguments[0].e : arguments[0]), h = o(h)) {
                    ...
                    if (!/^(stop|finish)$/i.test(g) && !p.isPlainObject(y)) {
                        var S = f + 1;
                        y = {};
                        for (var P = S; P < arguments.length; P++) v.isArray(arguments[P]) || !/^(fast|normal|slow)$/i.test(arguments[P]) && !/^\d/.test(arguments[P]) ? v.isString(arguments[P]) || v.isArray(arguments[P]) ? y.easing = arguments[P] : v.isFunction(arguments[P]) && (y.complete = arguments[P]) : y.duration = arguments[P]
                    }
                    var O = {
                        promise: null,
                        resolver: null,
                    ...
                    s && b.Promise && (O.promise = new b.Promise(function (t, e) {
                        ...
                        case "stop":
                            ...
                            return p.each(b.State.calls, function (t, e) {
                                e && p.each(e[1], function (i, a) {
                                    var o = y === n ? "" : y;
                                    return o !== !0 && e[2].queue !== o && (y !== n || e[2].queue !== !1) || void p.each(h, function (i, n) {
                                        n === a && ((y === !0 || v.isString(y)) && (p.each(p.queue(n, v.isString(y) ? y : ""), function (t, e) {
                                            v.isFunction(e) && e(null, !0)
                                        }), p.queue(n, v.isString(y) ? y : "", [])), "stop" === g ? (r(n) && r(n).tweensContainer && o !== !1 && p.each(r(n).tweensContainer, function (t, e) {
                                            e.endValue = e.currentValue
                                        }), A.push(t)) : "finish" === g && (e[2].duration = 1))
                                    })
                                })
                            }), "stop" === g && (p.each(A, function (t, e) {
                                d(e, !0)
                            ...
                            if (!p.isPlainObject(g) || v.isEmptyObject(g)) {
                                if (v.isString(g) && b.Redirects[g]) {
                                    var I = p.extend({}, y),
                                        q = I.duration,
                                        M = I.delay || 0;
                                    return I.backwards === !0 && (h = p.extend(!0, [], h).reverse()), p.each(h, function (t, e) {
                                ...
                                return O.promise ? O.rejecter(new Error(_)) : console.log(_), t()
                            }
                            E = "start"
                    }
                    var j = {
                    ...
                    var D, I = p.extend({}, b.defaults, y);
                    if (I.loop = parseInt(I.loop), D = 2 * I.loop - 1, I.loop)
                        for (var z = 0; D > z; z++) {
                            var L = {
                                delay: I.delay,
                                progress: I.progress
                            };
                            z === D - 1 && (L.display = I.display, L.visibility = I.visibility, L.complete = I.complete), C(h, "reverse", L)
                        }
                    return t()
                }
            };
        ...
        function x(t, e) {
            for (var i, a, o = e[0].toUpperCase() + e.slice(1), r = 0; r < lt.length;) {
                if (i = lt[r], a = i ? i + o : e, a in t) return a;
                r++
            }
            return n
        }
        ...
        function S(t) {
            ...
            return new(e = i ? i : mt ? H : yt ? F : gt ? W : L)(t, P)
        }
        ...
        function P(t, e, i) {
            var n = i.pointers.length,
                ...
                o = e & Tt && 0 === n - a,
                r = e & (Pt | Ot) && 0 === n - a;
            i.isFirst = !!o, i.isFinal = !!r, o && (t.session = {}), i.eventType = e, O(t, i), t.emit("hammer.input", i), t.recognize(i), t.session.prevInput = i
        }
        ...
        function O(t, e) {
            var i = t.session,
                n = e.pointers,
                a = n.length;
            i.firstInput || (i.firstInput = I(e)), a > 1 && !i.firstMultiple ? i.firstMultiple = I(e) : 1 === a && (i.firstMultiple = !1);
            var o = i.firstInput,
                r = i.firstMultiple,
                s = r ? r.center : o.center,
                l = e.center = q(n);
            e.timeStamp = ft(), e.deltaTime = e.timeStamp - o.timeStamp, e.angle = V(s, l), e.distance = j(s, l), E(i, e), e.offsetDirection = _(e.deltaX, e.deltaY), e.scale = r ? z(r.pointers, n) : 1, e.rotation = r ? D(r.pointers, n) : 0, A(i, e);
            var c = t.element;
        ...
        function E(t, e) {
            var i = e.center,
                ...
                a = t.prevDelta || {},
                o = t.prevInput || {};
            (e.eventType === Tt || o.eventType === Pt) && (a = t.prevDelta = {
                x: o.deltaX || 0,
                y: o.deltaY || 0
            }, n = t.offsetDelta = {
                x: i.x,
        ...
        function A(t, e) {
            ...
            if (e.eventType != Ot && (l > kt || s.velocity === n)) {
                var c = s.deltaX - e.deltaX,
                    u = s.deltaY - e.deltaY,
                    d = M(l, c, u);
                a = d.x, o = d.y, i = pt(d.x) > pt(d.y) ? d.x : d.y, r = _(c, u), t.lastInterval = e
        ...
        function _(t, e) {
            return t === e ? Et : pt(t) >= pt(e) ? t > 0 ? At : It : e > 0 ? qt : Mt
        }
        ...
        function D(t, e) {
            return V(e[1], e[0], zt) - V(t[1], t[0], zt)
        }

        function z(t, e) {
            return j(e[0], e[1], zt) / j(t[0], t[1], zt)
        }

        function L() {
            this.evEl = Ht, this.evWin = Nt, this.allow = !0, this.pressed = !1, T.apply(this, arguments)
        }

        function H() {
            this.evEl = $t, this.evWin = Wt, T.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
        }
        ...
        function Q(t, e) {
            ...
            return e & (Pt | Ot) && (i = w(i.concat(n), "identifier", !0)), [i, n]
        }
        ...
        function $(t, e) {
            ...
            for (a = 0; a < r.length;) n[r[a].identifier] && s.push(r[a]), e & (Pt | Ot) && delete n[r[a].identifier], a++;
        ...
        function at(t, e) {
            return e = e || {}, e.recognizers = p(e.recognizers, at.defaults.preset), new ot(t, e)
        }
        ...
        c(L, T, {
            handler: function (t) {
                var e = Lt[t.type];
                e & Tt && 0 === t.button && (this.pressed = !0), e & St && 1 !== t.which && (e = Pt), this.pressed && this.allow && (e & Pt && (this.pressed = !1), this.callback(this.manager, e, {
                    pointers: [t],
                    changedPointers: [t],
                    pointerType: xt,
                    srcEvent: t
        ...
        t.MSPointerEvent && ($t = "MSPointerDown", Wt = "MSPointerMove MSPointerUp MSPointerCancel"), c(H, T, {
            handler: function (t) {
                var e = this.store,
                    i = !1,
                ...
                a & Tt && (0 === t.button || r) ? 0 > s && (e.push(t), s = e.length - 1) : a & (Pt | Ot) && (i = !0), 0 > s || (e[s] = t, this.callback(this.manager, a, {
                    pointers: e,
                    changedPointers: [t],
                    pointerType: o,
                    srcEvent: t
        ...
        c(N, T, {
            handler: function (t) {
                ...
                if (e === Tt && (this.started = !0), this.started) {
                    ...
                    e & (Pt | Ot) && 0 === i[0].length - i[1].length && (this.started = !1), this.callback(this.manager, e, {
                        pointers: i[0],
                        changedPointers: i[1],
                        pointerType: bt,
                        srcEvent: t
        ...
        c(F, T, {
            ...
            handler: function (t, e, i) {
                ...
                e & (Pt | Ot) && (this.mouse.allow = !0), this.callback(t, e, i)
            },
            destroy: function () {
            ...
            preventDefaults: function (t) {
                if (!Zt) {
                    ...
                    var n = this.actions,
                        ...
                        o = g(n, ne),
                        r = g(n, ie);
                    return a || o && i & _t || r && i & jt ? this.preventSrc(e) : void 0
                }
            },
        ...
        Y.prototype = {
            ...
            canEmit: function () {
                for (var t = 0; t < this.requireFail.length;) {
                    if (!(this.requireFail[t].state & (ue | ae))) return !1;
                    t++
                }
                return !0
            },
            recognize: function (t) {
                var e = s({}, t);
                return d(this.options.enable, [this, e]) ? (this.state & (le | ce | ue) && (this.state = ae), this.state = this.process(e), void(this.state & (oe | re | se | ce) && this.tryEmit(e))) : (this.reset(), void(this.state = ue))
            },
            process: function () {},
            ...
            process: function (t) {
                var e = this.state,
                    ...
                    n = e & (oe | re),
                    a = this.attrTest(t);
                return n && (i & Ot || !a) ? e | ce : n || a ? i & Pt ? e | se : e & oe ? e | re : oe : ue
            }
        }), c(J, Z, {
            defaults: {
                event: "pan",
            ...
            getTouchAction: function () {
                var t = this.options.direction,
                    e = [];
                return t & _t && e.push(ne), t & jt && e.push(ie), e
            },
            directionTest: function (t) {
                var e = this.options,
                    ...
                    o = t.deltaX,
                    r = t.deltaY;
                return a & e.direction || (e.direction & _t ? (a = 0 === o ? Et : 0 > o ? At : It, i = o != this.pX, n = Math.abs(t.deltaX)) : (a = 0 === r ? Et : 0 > r ? qt : Mt, i = r != this.pY, n = Math.abs(t.deltaY))), t.direction = a, i && n > e.threshold && a & e.direction
            },
            attrTest: function (t) {
            ...
            process: function (t) {
                ...
                if (this._input = t, !n || !i || t.eventType & (Pt | Ot) && !o) this.reset();
            ...
            emit: function (t) {
                this.state === le && (t && t.eventType & Pt ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = ft(), this.manager.emit(this.options.event, this._input)))
            }
        }), c(et, Z, {
            defaults: {
                event: "rotate",
            ...
            attrTest: function (t) {
                ...
                return i & (_t | jt) ? e = t.velocity : i & _t ? e = t.velocityX : i & jt && (e = t.velocityY), this._super.attrTest.call(this, t) && i & t.direction && t.distance > this.options.threshold && pt(e) > this.options.velocity && t.eventType & Pt
            },
            emit: function (t) {
                var e = U(t.direction);
        ...
        ot.prototype = {
            ...
            recognize: function (t) {
                ...
                if (!e.stopped) {
                    ...
                    for (var o = 0; o < n.length;) i = n[o], e.stopped === pe || a && i != a && !i.canRecognizeWith(a) ? i.reset() : i.recognize(t), !a && i.state & (oe | re | se) && (a = e.curRecognizer = i), o++
                }
            },
            get: function (t) {
    ...
    function (t) {
        for (var e = 0, i = ["webkit", "moz"], n = t.requestAnimationFrame, a = t.cancelAnimationFrame, o = i.length; --o >= 0 && !n;) n = t[i[o] + "RequestAnimationFrame"], a = t[i[o] + "CancelRequestAnimationFrame"];
        n && a || (n = function (t) {
            var i = +Date.now(),
                n = Math.max(e + 16, i);
            return setTimeout(function () {
...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity,
        ...
        t.fn.collapsible = function (e) {
            ...
            return e = t.extend(i, e), this.each(function () {
                ...
                var l = t(this),
                    ...
                    u = l.data("collapsible");
                l.off("click.collapse", "> li > .collapsible-header"), c.off("click.collapse"), l.on("click.collapse", "> li > .collapsible-header", function (e) {
                    var i = t(e.target);
                    r(i) && (i = s(i)), i.toggleClass("active"), a(i)
    ...
    function (t) {
        t.fn.scrollTo = function (e) {
            ...
            return "open" === e ? (this.each(function () {
                ...
                function a(e) {
                    "focus" === e && (l = !0), n(), c.addClass("active"), r.addClass("active"), s.constrain_width === !0 ? c.css("width", r.outerWidth()) : c.css("white-space", "nowrap");
                    ...
                    var v = 0,
                        g = 0,
                        m = r.parent();
                    if (m.is("body") || (m[0].scrollHeight > m[0].clientHeight && (v = m[0].scrollTop), m[0].scrollWidth > m[0].clientWidth && (g = m[0].scrollLeft)), o + c.innerWidth() > t(window).width() ? d = "right" : o - c.innerWidth() + r.innerWidth() < 0 && (d = "left"), u + c.innerHeight() > i)
                        if (u + a - c.innerHeight() < 0) {
                            var y = i - u - h;
                            c.css("max-height", y)
                        } else h || (h += a), h -= c.innerHeight();
                    if ("left" === d) p = s.gutter, f = r.position().left + p;
                    else if ("right" === d) {
                        var b = r.position().left + r.outerWidth() - c.outerWidth();
                        p = -s.gutter, f = b + p
                    }
                    c.css({
                        position: "absolute",
                        top: r.position().top + h + v,
                        left: f + g
                ...
                if (n(), r.after(c), s.hover) {
                    ...
                    r.unbind("click." + r.attr("id")), r.on("mouseenter", function (t) {
                        ...
                        var i = e.toElement || e.relatedTarget;
                        t(i).closest(".dropdown-button").is(r) || (c.stop(!0, !0), o(), u = !1)
                    })
    ...
    function (t) {
                        ...
                        var a = t(this),
                            ...
                            r = function () {
                                var n = a.data("overlay-id"),
                                    o = t("#" + n);
                                a.removeClass("open"), t("body").css({
                                    overflow: "",
                                    width: ""
                                }), a.find(".modal-close").off("click.close"), t(document).off("keyup.modal" + n), o.velocity({
                                    opacity: 0
                                }, {
                                ...
                                var r = {
                                    ...
                                    complete: function () {
                                        t(this).css({
                                            display: "none"
                                        }), "function" == typeof i.complete && i.complete.call(this, a), o.remove(), e--
                                    }
                                };
                            ...
                            s = function (o) {
                                ...
                                if (s.css("overflow", "hidden"), s.width(l), !a.hasClass("open")) {
                                    ...
                                    a.hasClass("bottom-sheet") ? a.velocity({
                                        bottom: "0",
                                        opacity: 1
                                    }, d) : (t.Velocity.hook(a, "scaleX", .7), a.css({
                                        top: i.starting_top
                                    }), a.velocity({
                                        top: i.ending_top,
                                        opacity: 1,
        ...
        t.fn.modal = function (e) {
            return a[e] ? a[e].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof e && e ? void t.error("Method " + e + " does not exist on jQuery.modal") : a.init.apply(this, arguments)
        }
    }(jQuery),
    function (t) {
            ...
            return this.each(function () {
                ...
                if (!t(this).hasClass("initialized")) {
                    ...
                    l.wrap(c), l.on("click", function () {
                        ...
                        if (o === !1) return e(), !1;
                        if (a && o === !0) return e(), !1;
                        for (o = !1, l.addClass("active"), a = !0, s.css({
                        ...
                        var g = 0,
                            ...
                            b = 0,
                            w = 0;
                        m > y ? (g = p / d, b = .9 * c, w = .9 * c * g) : (g = d / p, b = .9 * u * g, w = .9 * u), l.hasClass("responsive-img") ? l.velocity({
                            "max-width": b,
                            width: d
                        }, {
                            duration: 0,
                            ...
                            complete: function () {
                                l.css({
                                    ...
                                    top: t(document).scrollTop() + u / 2 - l.parent(".material-placeholder").offset().top - w / 2
                                }, {
                                    duration: r,
                                    queue: !1,
                                    easing: "easeOutQuad",
            ...
            return this.each(function (i) {
                function n(i) {
                    ...
                    var o = a.children("img").first(),
                        ...
                        f = (p - c) / (n + d),
                        h = Math.round(s * f);
                    i && o.css("display", "block"), l > u && u + d > c && o.css("transform", "translate3D(-50%," + h + "px, 0)")
                }
                var a = t(this);
        ...
        var e = {
            init: function (e) {
                ...
                return e = t.extend(i, e), this.each(function () {
                    ...
                    i = t(o.filter('[href="' + location.hash + '"]')), 0 === i.length && (i = t(this).find("li.tab a.active").first()), 0 === i.length && (i = t(this).find("li.tab a").first()), i.addClass("active"), l = o.index(i), 0 > l && (l = 0), void 0 !== i[0] && (n = t(i[0].hash)), a.append('<div class="indicator"></div>');
                    ...
                    a.is(":visible") && setTimeout(function () {
                        ...
                        r = a.width(), s = Math.max(r, a[0].scrollWidth) / o.length, 0 > l && (l = 0), 0 !== s && 0 !== r && (d.css({
                            right: c(i)
                        }), d.css({
                            left: u(i)
                        }))
                    ...
                    }), a.on("click", "a", function (p) {
                        if (t(this).parent().hasClass("disabled")) return void p.preventDefault();
                        if (!t(this).attr("target")) {
                            r = a.width(), s = Math.max(r, a[0].scrollWidth) / o.length, i.removeClass("active"), void 0 !== n && n.hide(), i = t(this), n = t(Materialize.escapeHash(this.hash)), o = a.find("li.tab a"), i.position(), i.addClass("active");
                            var f = l;
                            l = o.index(t(this)), 0 > l && (l = 0), void 0 !== n && (n.show(), "function" == typeof e.onShow && e.onShow.call(this, n)), l - f >= 0 ? (d.velocity({
                                right: c(i)
                            }, {
                                duration: 300,
                                queue: !1,
    ...
    function (t) {
        t.fn.tooltip = function (i) {
            ...
            return "remove" === i ? (this.each(function () {
                ...
                var a = Materialize.guid(),
                    o = t(this);
                o.attr("data-tooltip-id") && t("#" + o.attr("data-tooltip-id")).remove(), o.attr("data-tooltip-id", a);
                var r, s, l, c, u, d, p = function () {
                ...
                var f = function () {
                    ...
                    return c = r ? t("<span></span>").html(c) : t("<span></span>").text(c), e.append(c).appendTo(t("body")).attr("id", a), d = t('<div class="backdrop"></div>'), d.appendTo(e), e
                };
                u = f(), o.off("mouseenter.tooltip mouseleave.tooltip");
                var h, v = !1;
                o.on({
                    "mouseenter.tooltip": function (t) {
                        var i = function () {
                            p(), v = !0, u.velocity("stop"), d.velocity("stop"), u.css({
                                display: "block",
                                left: "0px",
                                top: "0px"
                            });
                            var t, i, a, r = o.outerWidth(),
                                s = o.outerHeight(),
                                c = u.outerHeight(),
                                f = u.outerWidth(),
                                h = "0px",
                                ...
                                m = 8,
                                y = 8;
                            "top" === l ? (t = o.offset().top - c - n, i = o.offset().left + r / 2 - f / 2, a = e(i, t, f, c), h = "-10px", d.css({
                                bottom: 0,
                                left: 0,
                                borderRadius: "14px 14px 0 0",
                                transformOrigin: "50% 100%",
                                marginTop: c,
                                marginLeft: f / 2 - d.width() / 2
                            })) : "left" === l ? (t = o.offset().top + s / 2 - c / 2, i = o.offset().left - f - n, a = e(i, t, f, c), g = "-10px", d.css({
                                top: "-7px",
                                right: 0,
                                width: "14px",
                                height: "14px",
                                ...
                                marginTop: c / 2,
                                marginLeft: f
                            })) : "right" === l ? (t = o.offset().top + s / 2 - c / 2, i = o.offset().left + r + n, a = e(i, t, f, c), g = "+10px", d.css({
                                top: "-7px",
                                left: 0,
                                width: "14px",
                                height: "14px",
                                ...
                                marginTop: c / 2,
                                marginLeft: "0px"
                            })) : (t = o.offset().top + o.outerHeight() + n, i = o.offset().left + r / 2 - f / 2, a = e(i, t, f, c), h = "+10px", d.css({
                                top: 0,
                                left: 0,
                                marginLeft: f / 2 - d.width() / 2
                            })), u.css({
                                top: a.y,
                                left: a.x
                            }), m = Math.SQRT2 * f / parseInt(d.css("width")), y = Math.SQRT2 * c / parseInt(d.css("height")), u.velocity({
                                marginTop: h,
                                marginLeft: g
                            }, {
                                duration: 350,
        ...
        var e = function (e, i, n, a) {
            var o = e,
                r = i;
            return 0 > o ? o = 4 : o + n > window.innerWidth && (o -= o + n - window.innerWidth), 0 > r ? r = 4 : r + a > window.innerHeight + t(window).scrollTop && (r -= r + a - window.innerHeight), {
                x: o,
                y: r
            }
        };
    ...
    function (t) {
        ...
        var s = s || {},
            ...
            c = {
                ...
                show: function (t, e) {
                    ...
                    "touches" in t && (s = t.touches[0].pageY - r.top, l = t.touches[0].pageX - r.left), o.setAttribute("data-hold", Date.now()), o.setAttribute("data-scale", u), o.setAttribute("data-x", l), o.setAttribute("data-y", s);
                    var d = {
                        top: s + "px",
                        left: l + "px"
                    };
        ...
        null != l && (s = setInterval(function () {
            null === r.parentNode && window.clearInterval(s), r.classList.contains("panning") || (l -= 20), 0 >= l && (Vel(r, {
                opacity: 0,
                marginTop: "-40px"
            }, {
                duration: 375,
        ...
        var e = {
            init: function (e) {
                ...
                e = t.extend(i, e), t(this).each(function () {
                    ...
                    300 != e.menuWidth && n.css("width", e.menuWidth);
                    var a;
                    e.draggable ? (a = t('<div class="drag-target"></div>').attr("data-sidenav", i.attr("data-activates")), t("body").append(a)) : a = t(), "left" == e.edge ? (n.css("transform", "translateX(-100%)"), a.css({
                        left: 0
                    ...
                    e.draggable && (a.on("click", function () {
                        ...
                        if ("touch" == i.gesture.pointerType) {
                            var a = (i.gesture.direction, i.gesture.center.x),
                                ...
                                l = t("#sidenav-overlay"),
                                c = r.innerWidth();
                            if (r.css("overflow", "hidden"), r.width(c), 0 === l.length && (l = t('<div id="sidenav-overlay"></div>'), l.css("opacity", 0).click(function () {
                                    o()
                                }), t("body").append(l)), "left" === e.edge && (a > e.menuWidth ? a = e.menuWidth : 0 > a && (a = 0)), "left" === e.edge) a < e.menuWidth / 2 ? s = !1 : a >= e.menuWidth / 2 && (s = !0), n.css("transform", "translateX(" + (a - e.menuWidth) + "px)");
                            else {
                                a < window.innerWidth - e.menuWidth / 2 ? s = !0 : a >= window.innerWidth - e.menuWidth / 2 && (s = !1);
                                var u = a - e.menuWidth / 2;
                                0 > u && (u = 0), n.css("transform", "translateX(" + u + "px)")
                            }
                            var d;
                            "left" === e.edge ? (d = a / e.menuWidth, l.velocity({
                                opacity: d
                            }, {
                                duration: 10,
                                queue: !1,
                                easing: "easeOutQuad"
                            })) : (d = Math.abs((a - window.innerWidth) / e.menuWidth), l.velocity({
                                opacity: d
                            }, {
                                duration: 10,
                                queue: !1,
                        ...
                        if ("touch" == i.gesture.pointerType) {
                            var o = t('<div id="sidenav-overlay"></div>'),
                                ...
                                u = c - e.menuWidth,
                                d = c - e.menuWidth / 2;
                            u > 0 && (u = 0), 0 > d && (d = 0), r = !1, "left" === e.edge ? s && .3 >= l || -.5 > l ? (0 !== u && n.velocity({
                                translateX: [0, u]
                            }, {
                                duration: 300,
                                queue: !1,
    ...
    function (t) {
        ...
        function i(i) {
            ...
            var n = o.scrollTop(),
                ...
                r = a + o.width(),
                l = n + o.height(),
                d = e(n + u.top + i || 200, r + u.right, l + u.bottom, a + u.left);
        ...
        function a(t, e, i) {
            ...
            return function () {
                ...
                s || i.leading !== !1 || (s = c);
                var u = e - (c - s);
                return n = this, a = arguments, 0 >= u ? (clearTimeout(r), r = null, s = c, o = t.apply(n, a), n = a = null) : r || i.trailing === !1 || (r = setTimeout(l, u)), o
            }
        }
        var o = t(window),
            r = [],
        ...
        t.scrollSpy = function (e, n) {
            ...
            return l || (o.on("scroll", p), o.on("resize", p), l = !0), setTimeout(p, 0), e.on("scrollSpy:enter", function () {
                c = t.grep(c, function (t) {
                    return 0 != t.height()
                });
                var e = t(this);
                c[0] ? (t('a[href="#' + c[0].attr("id") + '"]').removeClass("active"), e.data("scrollSpy:id") < c[0].data("scrollSpy:id") ? c.unshift(t(this)) : c.push(t(this))) : c.push(t(this)), t('a[href="#' + c[0].attr("id") + '"]').addClass("active")
        ...
        t(document).ready(function () {
            function e(e) {
                var i = e.css("font-family"),
                    n = e.css("font-size"),
                    o = e.css("line-height");
                n && a.css("font-size", n), i && a.css("font-family", i), o && a.css("line-height", o), "off" === e.attr("wrap") && a.css("overflow-wrap", "normal").css("white-space", "pre"), a.text(e.val() + "\n");
            ...
            t(document).on("change", i, function () {
                ...
                var e = t(this),
                    i = ".prefix";
                0 === e.val().length && e[0].validity.badInput !== !0 && void 0 === e.attr("placeholder") && (i += ", label"), e.siblings(i).removeClass("active"), validate_field(e)
            ...
            t(document).on("change", s, function (e) {
                ...
                return e = t.extend(i, e), this.each(function () {
                    var i = t(this),
                        n = e.data,
                        a = i.closest(".input-field");
                    if (!t.isEmptyObject(n)) {
                        var o = t('<ul class="autocomplete-content dropdown-content"></ul>');
                        a.length ? a.append(o) : i.after(o);
                        var r = function (t, e) {
                            var i = e.find("img"),
                                ...
                                s = e.text().slice(a + 1);
                            e.html("<span>" + o + "<span class='highlight'>" + r + "</span>" + s + "</span>"), i.length && e.prepend(i)
                        };
                        i.on("keyup", function (e) {
                            if (13 === e.which) return void o.find("li").first().click();
                            var a = i.val().toLowerCase();
                            if (o.empty(), "" !== a)
                                for (var s in n)
                                    if (n.hasOwnProperty(s) && -1 !== s.toLowerCase().indexOf(a) && s.toLowerCase() !== a) {
                                        var l = t("<li></li>");
                                        n[s] ? l.append('<img src="' + n[s] + '" class="right circle"><span>' + s + "</span>") : l.append("<span>" + s + "</span>"), o.append(l), r(a, l)
                                    }
            ...
            t(this).each(function () {
                ...
                if (!n.hasClass("browser-default")) {
                    ...
                    var l = t('<ul id="select-options-' + r + '" class="dropdown-content select-dropdown ' + (a ? "multiple-select-dropdown" : "") + '"></ul>'),
                        ...
                        f = function (e, i, n) {
                            ...
                            if (r) {
                                var c = "";
                                return s && (c = ' class="' + s + '"'), "multiple" === n ? l.append(t('<li class="' + a + '"><img alt="" src="' + r + '"' + c + '><span><input type="checkbox"' + a + "/><label></label>" + i.html() + "</span></li>")) : l.append(t('<li class="' + a + o + '"><img alt="" src="' + r + '"' + c + "><span>" + i.html() + "</span></li>")), !0
                            }
                    ...
                    var v = p.replace(/"/g, "&quot;"),
                        g = t('<input type="text" class="select-dropdown" readonly="true" ' + (n.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + r + '" value="' + v + '"/>');
        ...
        var e = {
            init: function (e) {
                ...
                return e = t.extend(i, e), this.each(function () {
                    ...
                    function n(t) {
                        t >= c.length ? t = 0 : 0 > t && (t = c.length - 1), u = l.find(".active").index(), u != t && (a = c.eq(u), $caption = a.find(".caption"), a.removeClass("active"), a.velocity({
                            opacity: 0
                        }, {
                    ...
                    var a, o, r, s = t(this),
                        ...
                        a.click(function () {
                            ...
                            n(a), clearInterval(r), r = setInterval(function () {
                                u = l.find(".active").index(), c.length == u + 1 ? u = 0 : u += 1, n(u)
                            }, e.transition + e.interval)
                        }), o.append(a)
                    }), s.append(o), o = s.find("ul.indicators").find("li.indicator-item")), a ? a.show() : (c.first().addClass("active").velocity({
                        opacity: 1
                    }, {
                        duration: e.transition,
                        queue: !1,
                        easing: "easeOutQuad"
                    }), u = 0, a = c.eq(u), e.indicators && o.eq(u).addClass("active")), a.find("img").each(function () {
                    ...
                    s.hammer({
                        ...
                        if ("touch" === t.gesture.pointerType) {
                            ...
                            var a;
                            p && (a = $curr_slide.next(), 0 === a.length && (a = c.first()), a.velocity({
                                opacity: 1
                            }, {
                                duration: 300,
                                queue: !1,
                                easing: "easeOutQuad"
                            })), f && (a = $curr_slide.prev(), 0 === a.length && (a = c.last()), a.velocity({
                                opacity: 1
                            }, {
                                duration: 300,
                                queue: !1,
                        ...
                        "touch" === t.gesture.pointerType && ($curr_slide = l.find(".active"), d = !1, curr_index = l.find(".active").index(), !f && !p || c.length <= 1 ? $curr_slide.velocity({
                            translateX: 0
                        }, {
                            duration: 300,
                            queue: !1,
    ...
    function (t) {
        ...
        t(document).ready(function () {
            t(document).on("click", ".chip .close", function (e) {
                var i = t(this).closest(".chips");
                i.attr("data-initialized") || t(this).closest(".chip").remove()
            })
            ...
            this.init = function () {
                ...
                a.$el.each(function () {
                    var i = t(this),
                        n = Materialize.guid();
                    o.data && o.data instanceof Array || (o.data = []), i.data("chips", o.data), i.attr("data-index", e), i.attr("data-initialized", !0), i.hasClass(a.SELS.CHIPS) || i.addClass("chips"), a.chips(i, n), e++
                })
            }, this.handleEvents = function () {
                var e = a.SELS;
                a.$document.off("click.chips-focus", e.CHIPS).on("click.chips-focus", e.CHIPS, function (i) {
                    ...
                    if (!t(i.target).is("input, textarea")) {
                        var n, o = a.$document.find(e.CHIP + e.SELECTED_CHIP),
                            r = o.closest(e.CHIPS),
                            s = o.siblings(e.CHIP).length;
                        if (o.length)
                            if (8 === i.which || 46 === i.which) {
                                i.preventDefault(), n = o.index(), a.deleteChip(n, r);
                                var l = null;
                                s > n + 1 ? l = n : (n === s || n + 1 === s) && (l = s - 1), 0 > l && (l = null), null !== l && a.selectChip(l, r), s || r.find("input").focus()
                            } else if (37 === i.which) {
                            if (n = o.index() - 1, 0 > n) return;
                            t(e.CHIP).removeClass("selected"), a.selectChip(n, r)
                        } else if (39 === i.which) {
                            if (n = o.index() + 1, t(e.CHIP).removeClass("selected"), n > s) return void r.find("input").focus();
                            a.selectChip(n, r)
                        }
                    }
                    ...
                    var n = t(i.target).closest(e.CHIPS);
                    n.removeClass("focus"), n.data("chips").length || n.siblings("label").removeClass("active"), n.siblings(".prefix").removeClass("active")
                }), a.$document.off("keydown.chips-add", e.CHIPS + " " + e.INPUT).on("keydown.chips-add", e.CHIPS + " " + e.INPUT, function (i) {
                    var n = t(i.target),
                        o = n.closest(e.CHIPS),
                        r = o.children(e.CHIP).length;
                    return 13 === i.which ? (i.preventDefault(), a.addChip({
                        tag: n.val()
                    }, o), void n.val("")) : 8 !== i.keyCode && 37 !== i.keyCode || "" !== n.val() || !r ? void 0 : (a.selectChip(r - 1, o), void n.blur())
                }), a.$document.off("click.chips-delete", e.CHIPS + " " + e.DELETE).on("click.chips-delete", e.CHIPS + " " + e.DELETE, function (i) {
                    var n = t(i.target),
                        o = n.closest(e.CHIPS),
                        r = n.closest(e.CHIP);
                    i.stopPropagation(), a.deleteChip(r.index(), o), o.find("input").focus()
                })
            }, this.chips = function (t, e) {
                var i = "";
                t.data("chips").forEach(function (t) {
                    i += a.renderChip(t)
                }), i += '<input id="' + e + '" class="input" placeholder="">', t.html(i), a.setPlaceholder(t);
                var n = t.next("label");
                n.length && (n.attr("for", e), t.data("chips").length && n.addClass("active"))
            }, this.renderChip = function (t) {
                if (t.tag) {
                    var e = '<div class="chip">' + t.tag;
                    return t.image && (e += ' <img src="' + t.image + '"> '), e += '<i class="material-icons close">close</i>', e += "</div>"
                }
                ...
                if (a.isValid(i, e)) {
                    for (var n = a.renderChip(e), o = [], r = i.data("chips"), s = 0; s < r.length; s++) o.push(r[s]);
                ...
                for (var n = [], o = e.data("chips"), r = 0; r < o.length; r++) r !== t && n.push(o[r]);
        ...
        t.fn.pushpin = function (e) {
            ...
            return "remove" === e ? (this.each(function () {
                ...
                var a = Materialize.guid(),
                    o = t(this),
                    r = t(this).offset().top;
                t(this).data("pushpin-id", a), n(o, t(window).scrollTop()), t(window).on("scroll." + a, function () {
    ...
    function (t) {
        ...
        var e = function (e) {
                var i = e;
                if (i.hasClass("active") === !1) {
                    var n, a, o = i.hasClass("horizontal");
                    o === !0 ? a = 40 : n = 40, i.addClass("active"), i.find("ul .btn-floating").velocity({
                        scaleY: ".4",
                        scaleX: ".4",
                        translateY: n + "px",
                        translateX: a + "px"
            ...
            i = function (t) {
                var e, i, n = t,
                    a = n.hasClass("horizontal");
                a === !0 ? i = 40 : e = 40, n.removeClass("active"), n.find("ul .btn-floating").velocity("stop", !0), n.find("ul .btn-floating").velocity({
                    opacity: "0",
                    scaleX: ".4",
                    scaleY: ".4",
                    translateY: e + "px",
            ...
            n = function (e) {
                if ("true" !== e.attr("data-open")) {
                    ...
                    c.append(d), i = l.left - r / 2 + l.width / 2, n = s - l.bottom, o = r / d.width(), e.attr("data-origin-bottom", l.bottom), e.attr("data-origin-left", l.left), e.attr("data-origin-width", l.width), e.addClass("active"), e.attr("data-open", !0), e.css({
                        "text-align": "center",
                        width: "100%",
                        bottom: 0,
                        left: 0,
            ...
            a = function (t) {
                if ("true" === t.attr("data-open")) {
                    var e, i, n, a = window.innerWidth,
                        ...
                        p = c.css("background-color");
                    e = l - a / 2 + r / 2, i = o - s, n = a / d.width(), t.removeClass("active"), t.attr("data-open", !1), t.css({
        ...
        function e(o, r, l, d) {
            ...
            var y = !1,
                ...
                T = k.prototype = {
                    ...
                    $node: C,
                    start: function () {
                        return b && b.start ? T : (b.methods = {}, b.start = !0, b.open = !1, b.type = o.type, o.autofocus = o == s(), o.readOnly = !w.editable, o.id = o.id || b.id, "text" != o.type && (o.type = "text"), T.component = new l(T, w), T.$root = t(e._.node("div", p(), x.picker, 'id="' + o.id + '_root" tabindex="0"')), h(), w.formatSubmit && v(), f(), w.container ? t(w.container).append(T.$root) : C.after(T.$root), T.on({
                            ...
                            close: w.onClose,
                            set: w.onSet
                        }), y = i(T.$root.children()[0]), o.autofocus && T.open(), T.trigger("start").trigger("render"))
                    },
                    render: function (t) {
                    ...
                    open: function (i) {
                        return b.open ? T : (C.addClass(x.active), a(o, "expanded", !0), setTimeout(function () {
                            ...
                            var n = i.keyCode,
                                a = T.component.key[n],
                                o = i.target;
                            27 == n ? T.close(!0) : o != T.$root[0] || !a && 13 != n ? t.contains(T.$root[0], o) && 13 == n && (i.preventDefault(), o.click()) : (i.preventDefault(), a ? e._.trigger(T.component.key.go, T, [e._.trigger(a)]) : T.$root.find("." + x.highlighted).hasClass(x.disabled) || T.set("select", T.component.item.highlight).close())
                        })), T.trigger("open"))
                    },
                    close: function (t) {
                    ...
                    set: function (e, i, n) {
                        ...
                        if (n = r && t.isPlainObject(i) ? i : n || {}, e) {
                            r || (s[e] = i);
                            for (a in s) o = s[a], a in T.component.item && (void 0 === o && (o = null), T.component.set(a, o, n)), ("select" == a || "clear" == a) && C.val("clear" == a ? "" : T.get(a, w.format)).trigger("change");
                            T.render()
                        }
    ...
    function (t) {
        ...
        i.prototype.set = function (t, e, i) {
            ...
            var a, o, r, s, l = e.isArray(i),
                ...
                u = this.item.view;
            if (l || c) {
                for (c ? (o = i.year, r = i.month, s = i.date) : (o = +i[0], r = +i[1], s = +i[2]), n && n.nav && u && u.month !== r && (o = u.year, r = u.month), a = new Date(o, r + (n && n.nav ? n.nav : 0), 1), o = a.getFullYear(), r = a.getMonth(); new Date(o, r, s).getMonth() !== r;) s -= 1;
                i = [o, r, s]
            }
            return i
            ...
            if ((!n || !n.nav) && (!p && c.disabled(i) || p && c.disabled(i) && (v || a || r) || !p && (i.pick <= f.pick || i.pick >= h.pick)))
                for (p && !v && (!r && d > 0 || !a && 0 > d) && (d *= -1); c.disabled(i) && (Math.abs(d) > 1 && (i.month < u.month || i.month > u.month) && (i = u,
                        d = d > 0 ? 1 : -1), i.pick <= f.pick ? (s = !0, d = 1, i = c.create([f.year, f.month, f.date + (i.pick === f.pick ? 0 : -1)])) : i.pick >= h.pick && (l = !0, d = -1, i = c.create([h.year, h.month, h.date + (i.pick === h.pick ? 0 : 1)])), !s || !l);) i = c.create([i.year, i.month, i.date + d]);
            return i
            ...
            return o.isInteger(t) && (o.isDate(i) || e.isArray(i)) ? (t = t % 7 + a, t === n.create(i).day + 1) : o.isInteger(i) && (o.isDate(t) || e.isArray(t)) ? (i = i % 7 + a, i === n.create(t).day + 1) : !(!e.isPlainObject(t) || !e.isPlainObject(i)) && n.overlapRanges(t, i)
            ...
            var e = this,
                ...
                v = function (t) {
                    return o.node("div", " ", i.klass["nav" + (t ? "Next" : "Prev")] + (t && u.year >= f.year && u.month >= f.month || !t && u.year <= p.year && u.month <= p.month ? " " + i.klass.navDisabled : ""), "data-nav=" + (t || -1) + " " + o.ariaAttr({
                        role: "button",
                ...
                g = function (n) {
                    ...
                    return "short_months" == n && (a = i.monthsShort), i.selectMonths && void 0 == n ? o.node("select", o.group({
                        ...
                        node: "option",
                        item: function (t) {
                            return [a[t], 0, "value=" + t + (u.month == t ? " selected" : "") + (u.year == p.year && t < p.month || u.year == f.year && t > f.month ? " disabled" : "")]
                        }
                    }), i.klass.selectMonth + " browser-default", (t ? "" : "disabled") + " " + o.ariaAttr({
                        controls: e.$node[0].id + "_table"
                    }) + ' title="' + i.labelMonthSelect + '"') : "short_months" == n ? null != l ? o.node("div", a[l.month]) : o.node("div", a[u.month]) : o.node("div", a[u.month], i.klass.month)
                },
                m = function (n) {
                    var a = u.year,
            ...
            return createDayLabel = function () {
                ...
                return e
            }, o.node("div", o.node("div", createWeekdayLabel(), "picker__weekday-display") + o.node("div", g("short_months"), i.klass.month_display) + o.node("div", createDayLabel(), i.klass.day_display) + o.node("div", m("raw"), i.klass.year_display), i.klass.date_display) + o.node("div", o.node("div", (i.selectYears ? g() + m() : g() + m()) + v() + v(1), i.klass.header) + o.node("table", h + o.node("tbody", o.group({
                min: 0,
                max: a - 1,
                i: 1,
                node: "tr",
                item: function (t) {
                    var a = i.firstDay && 0 === e.create([u.year, u.month, 1]).day ? -7 : 0;
                    return [o.group({
                        min: n * t - u.day + a + 1,
                        max: function () {
                            return this.min + n - 1
                        ...
                        item: function (t) {
                            ...
                            var n = l && l.pick == t.pick,
                                a = c && c.pick == t.pick,
                                r = d && e.disabled(t) || t.pick < p.pick || t.pick > f.pick,
                                h = o.trigger(e.formats.toString, e, [i.format, t]);
    ...
    function (t) {
        ...
        t.fn.characterCounter = function () {
            return this.each(function () {
                var a = t(this),
                    o = a.parent().find('span[class="character-counter"]');
                if (!o.length) {
                    var r = void 0 !== a.attr("length");
                    r && (a.on("input", e), a.on("focus", e), a.on("blur", n), i(a))
                }
            })
        }, t(document).ready(function () {
    ...
    function (t) {
        var e = {
            init: function (e) {
                ...
                return e = t.extend(i, e), this.each(function () {
                    function i() {
                        "undefined" != typeof window.ontouchstart && (_[0].addEventListener("touchstart", d), _[0].addEventListener("touchmove", p), _[0].addEventListener("touchend", f)), _[0].addEventListener("mousedown", d), _[0].addEventListener("mousemove", p), _[0].addEventListener("mouseup", f), _[0].addEventListener("mouseleave", f), _[0].addEventListener("click", c)
                    }
                    ...
                    function s() {
                        var t, e, i, n;
                        t = Date.now(), e = t - E, E = t, i = v - O, O = v, n = 1e3 * i / (1 + e), S = .8 * n + .2 * S
                    }

                    function l() {
                        var t, i;
                        k && (t = Date.now() - E, i = k * Math.exp(-t / e.time_constant), i > 2 || -2 > i ? (r(T - i), requestAnimationFrame(l)) : r(T))
                    }
                    ...
                    function c(i) {
                        ...
                        if (!e.full_width) {
                            var n = t(i.target).closest(".carousel-item").index(),
                                a = g % w - n;
                            0 !== a && (i.preventDefault(), i.stopPropagation()), u(n)
                        }
                    }

                    function u(t) {
                        var i = g % w - t;
                        e.no_wrap || (0 > i ? Math.abs(i + w) < Math.abs(i) && (i += w) : i > 0 && Math.abs(i - w) < i && (i -= w)), 0 > i ? _.trigger("carouselNext", [Math.abs(i)]) : i > 0 && _.trigger("carouselPrev", [i])
                    }
                    ...
                    function p(t) {
                        var e, i, o;
                        if (m)
                            if (e = n(t), y = a(t), i = x - e, o = Math.abs(C - y), 30 > o && !q)(i > 2 || -2 > i) && (I = !0, x = e, r(v + i));
                            else {
                    ...
                    var h, v, g, m, b, w, x, C, k, T, S, P, O, E, A, I, q, M = t('<ul class="indicators"></ul>'),
                        _ = t(this),
                        j = _.attr("data-indicators") || e.indicators;
                    if (_.hasClass("initialized")) return t(this).trigger("carouselNext", [1e-6]), !0;
                    if (e.full_width) {
                        e.dist = 0;
                        var V = _.find(".carousel-item img").first();
                        V.length ? imageHeight = V.on("load", function () {
                    ...
                    _.addClass("initialized"), m = !1, v = T = 0, h = [], item_width = _.find(".carousel-item").first().innerWidth(), b = 2 * item_width + e.padding, _.find(".carousel-item").each(function (e) {
                        if (h.push(t(this)[0]), j) {
                            ...
                            0 === e && i.addClass("active"), i.click(function () {
                                var e = t(this).index();
                                u(e)
                            }), M.append(i)
                        }
                        ...
                        var e = t + "Transform";
                        return "undefined" == typeof document.body.style[e] || (P = e, !1)
