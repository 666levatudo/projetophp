<?php
    ...
    $email = $_GET['us'];
	$sql = mysql_query("SELECT * FROM empresa WHERE email = '$email'");
    ...
    <div class="row">
        <div class="col-md-12" style="background-color:#0E1724;height:100px;overflow:hidden;">
            <div class="container">
				...
				<img src="../paginas/fotos/<?php echo $foto; ?>" id="foto_perfil" style="width:50px;height:50px;">
				<?php echo "<div style='color:white !important;font-family:calibri light;font-size:20px;'>$nome</div>"; ?><br>
				<a href="logout_empresa.php"><p style='color:white !important;font-family:calibri light;'>Sair</p></a>
				</div>
            </div>
        </div>
    </div>
                    ...
                    <div class="caixa_perfil">
                       <div class="lado_esq">
                        <div class="foto_perfil">
                            <img src="../paginas/fotos/<?php echo $foto; ?>" alt="" width="80" height="80">
                        </div>
                    </div>
